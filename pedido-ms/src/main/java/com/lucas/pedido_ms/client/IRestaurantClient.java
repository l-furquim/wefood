...
public interface IRestaurantClient {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/v1/api/restaurants/id/{id}")
    ResponseEntity<RestaurantDto> getById(@PathVariable("id") Long id, @RequestHeader("Authorization") String token);
